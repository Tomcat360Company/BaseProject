...
package com.noway.netutils.net.cookie;
...
public class PersistentCookieStore {
    ...
    protected String encodeCookie(SerializableOkHttpCookies cookie) {
        ...
        try {
            ...
            Log.d(TAG,"IOException in encodeCookie" + e.getMessage());
            return null;
        }
    ...
    protected Cookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            Log.d(TAG,"IOException in decodeCookie" + e.getMessage());
        } catch (ClassNotFoundException e) {
            Log.d(TAG,"ClassNotFoundException in decodeCookie" + e.getMessage());
        }
